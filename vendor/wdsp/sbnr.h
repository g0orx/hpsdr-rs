...
and used libspecbleach (https://github.com/lucianodato/libspecbleach).

STUBBED (2026-09-08, see this project's memory/wdsp_210_port.md): the
vendored libspecbleach library this file originally called into has
been removed -- see sbnr.c's own updated header comment for why (this
stage is never enabled anywhere in this project).
*/
...
typedef struct _sbnr {
  ...
  void *st; // was libspecbleach's SpectralBleachHandle; unused now, kept for layout
  int buffer_size;
  int rate;
