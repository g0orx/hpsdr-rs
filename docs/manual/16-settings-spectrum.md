[← RX](15-settings-rx.md) | [Index](README.md) | [TX →](17-settings-tx.md)
...
doesn't jump on every noise spike or edge artifact). **On by default.**
While **Auto** is on, the **Low** slider is disabled -- turn **Auto** off
to set it manually
